...
function TriagePageCreate() {
  ...
  const [InpantientDepartments, setInpantientDepartments] = useState<
    InpantientDepartmentInterface[]
  >([]);
          ...
          <Grid container spacing={2} sx={{ padding: 2 }}>
            <Grid item xs={10}>
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="">กรุณาเลือกผู้ป่วย</MenuItem>
            ...
            <Grid item xs={6}>
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="">กรุณาเลือกโรค</MenuItem>
                  {Diseases.map((diseases) => (
                    <MenuItem value={diseases.ID} key={diseases.ID}>
            ...
            <Grid item xs={6}>
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="">กรุณาเลือกแผนก</MenuItem>
                  {InpantientDepartments.map((inpantientdepartment) => (
                    <MenuItem
                      value={inpantientdepartment.ID}
                      key={inpantientdepartment.ID}
                    >
                      {inpantientdepartment.InpantientDepartment_NAME}
                    </MenuItem>
                  ))}
                </Select>
              </FormControl>
